    ...
    <div>
        ...
        <el-dialog
            ...
            <el-form ref="form1" :model="form1" :rules="rules" label-width="80px">
                ...
                <el-form-item label="仓库名" prop="storage">
                    <el-col :span="20">
                        <el-input v-model="form1.storage"></el-input>
                    </el-col>
                </el-form-item>
                <el-form-item label="货物分类" prop="goodstype">
                    <el-col :span="20">
                        <el-input v-model="form1.goodstype"></el-input>
                    </el-col>
                </el-form-item>
                <el-form-item label="货物数量" prop="count">
                    <el-col :span="20">
...
export default {
    ...
    data() {
        ...
        let checkDuplicate =(rule,value,callbacke)=>{
            ...
            this.$axios.get(this.$http+'/goods/findByName?name='+this.form.name).then(res=>res.data).then(res=>{
                //console.log(res)
                if (res.code!==200){
                    return callbacke
                }else {
    ...
    methods:{
        ...
        save(){
            ...
            this.$axios.post(this.$http+"/goods/save ", this.form).then(res=>res.data).then(res=>{
                console.log(res)
                if (res.code===200){
                    this.$message({
                        showClose: true,
        ...
        showUpdate(row){
            ...
            this.form1.count = row.count
            this.form1.storage = row.storage
            this.form1.goodstype =row.goodstype
            this.centerDialogVisible1=true
        },
        //3.修改信息
        update(){
            this.$axios.put(this.$http+'/goods/update',this.form1).then(res=>res.data).then(res=>{
                //console.log(res)
                if (res.code===200){
                    this.$message({
                        showClose: true,
        ...
        deleteUser(id){
            //console.log(id)
            this.$axios.delete(this.$http+'/goods/delete?id='+id).then(res=>res.data).then(res=>{
                //console.log(res)
                if (res.code===200){
                    this.$message({
                        showClose: true,
        ...
        loadGet(){
            this.$axios.get(this.$http+'/goods/page',{
                params:{
        ...
        loadPost(){
            ...
            this.$axios.post(this.$http+"/goods/list1", SelectBean).then(res=>res.data).then(res=>{
                //console.log((res))
                if (res.code===200){
                    this.tableData = res.data
                    this.total=res.total
